...
function readData() {
  try {
    ...
    return { 
      team: [{ id: 'isha_01', name: 'Isha Singh', title: 'Associate - Global Partnerships', email: 'ishaa@joveo.com', color: '#2563eb' }], 
      gaps: [] 
    };
  }
}
...
For every publisher found, you MUST research/identify a specific contact person and their email address.
Format: [{"name":"Name","url":"URL","contact_person":"Person Name","contact_email":"email@example.com","why":"Value","model":"CPC/CPA","priority":"HIGH"}]
Exclude: Indeed, LinkedIn, ZipRecruiter, Monster, CareerBuilder, Glassdoor.
Default Sender: Isha Singh (ishaa@joveo.com).`;
